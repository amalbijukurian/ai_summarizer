...
const features = [
  {
    ...
    description:
      "Convert 100+ page PDFs into key insights, executive summaries, and bullet points in seconds.",
  ...
  },
  {
    ...
    description:
      "Chat with your document like a conversational assistant. Ask questions, clarify details, and get cited answers.",
  ...
  },
  {
    ...
    description:
      "Extract concrete tasks, deadlines, and deliverables hidden in complex business documents automatically.",
  ...
  },
  {
    ...
    description:
      "Every summary point and chatbot answer maps back to precise page numbers and original paragraphs.",
  ...
  },
  {
    ...
    description:
      "Upload a document in any language and get summaries or answers in English, French, Spanish, Japanese, and more.",
  ...
  },
  {
    ...
    description:
      "Your documents are securely encrypted in transit and at rest. Files are strictly private and never used to train models.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-lg text-slate-600">
            Engineered to help students, researchers, and professionals digest
            mountains of information in record time.
          </p>
        </div>
