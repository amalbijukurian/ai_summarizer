...
export default function HeroSection() {
    return <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-15 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
            <div className="flex">
               ...
               <Badge variant={'secondary'} className="relative px-6 py-3 text-base font-medium bg-white rounded-full group-hover:bg-gray-50 transition-colors duration-200">
            ...
            rounded-full px-8 sm:px-10 lg:px-12 py-6 sm:py-7 lg:py-8 lg:mt-16 bg-gradient-to-r from-slate-900 to-rose-500
